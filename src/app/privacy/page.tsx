...
export const metadata = {
  ...
  description: 'Политика обработки персональных данных ландшафтного бюро «Место силы».',
};
    ...
    <div className="max-w-4xl mx-auto px-6 sm:px-8 py-12 space-y-8 font-sans text-graphite/80 leading-relaxed">
      ...
      <div className="space-y-6 text-sm">
        <section className="space-y-2">
          ...
          <p>
            Настоящая Политика обработки персональных данных определяет порядок обработки и защиты информации о физических лицах (далее — Пользователи), отправляющих свои данные через формы на сайте ландшафтного бюро «Место силы» Анастасии Лацинник.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Ландшафтное бюро «Место силы» не передает полученные персональные данные третьим лицам, за исключением случаев, предусмотренных действующим законодательством.
          </p>
        </section>
